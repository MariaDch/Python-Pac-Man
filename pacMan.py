...
def reinitialize(livs):
    return livs, 0, False, 0, 365, 522, 0, 0, 0, 50, 58, 0, 362, 300, 2, 362, 345, 2, 362, 345, 2, \
           [False, False, False, False], False, False, False, False


def start_pacman(lvl):
    pygame.init()
    ...
    level = copy.deepcopy(boards[lvl])  # [difficulty: 0-easy, 1-medium, 2-hard]
    if lvl == 0:
        color = 'green'
    elif lvl == 1:
        color = 'orange'
    ...
    while run:
        ...
        draw_player()
        blinky = Ghost(blinky_x, blinky_y, ghost_targets[0], ghosts_speeds[0], blinky_image, blinky_direction,
                       blinky_dead,
                       blinky_in_box, 0)
